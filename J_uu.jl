    ...
    for i=1:3
        for j=1:3
            if i==j
                ...
                f_xx = (f1 - 2*nom_f + f2)/(h^2) # f(x+h,y) - 2f(x,y) + f(x-h,y) / h^2
                J_uu[i,j] = f_xx
            else
...
print(J_uu()) 
[-7.460756212456425 -2.1357095953626186 -279.49599111708557;
 -2.1357096398458104 -98.18393713138755 -0.004659896230874663;
  -279.49599111708557 -0.004659896230874663 -0.0007855014350343562]